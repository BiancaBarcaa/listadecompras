...
const listaRecuperada = localStorage.getItem('listaDEeItens')
...
function eliminaAcentos(i){
    letrasAcentuadas = "ÁAÀAÃAÂAÉEÈEÊEÍIÌIÓOÒOÔOÕOÚUÙUÛUáaàaãaâaéeèeêeíiìióoòoôoõoúuùuûu";
...
function salvarItem() {
    ...
    const checarDuplicado = listaDeItens.some((elemento) => eliminaAcentos(elemento.valor.toUpperCase()) === eliminaAcentos(comprasItem.toUpperCase()))
